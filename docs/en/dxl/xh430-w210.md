...
{% include en/dxl/specifications_x.md passed_ref = page.ref %}
...
{% include en/dxl/control_table_id.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="baud-rate"></a>**[Baud Rate(8)](#baud-rate8)**
{% include en/dxl/control_table_baudrate_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="return-delay-time"></a>**[Return Delay Time(9)](#return-delay-time9)**
{% include en/dxl/control_table_return_delay_time.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="drive-mode"></a>**[Drive Mode(10)](#drive-mode10)**
{% include en/dxl/control_table_drivemode.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="operating-mode"></a>**[Operating Mode(11)](#operating-mode11)**
{% include en/dxl/control_table_opmode_six_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="secondary-shadow-id"></a>**[Secondary(Shadow) ID(12)](#secondaryshadow-id12)**
{% include en/dxl/control_table_shadowid.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="protocol-version"></a>**[Protocol Type(13)](#protocol-type13)**
{% include en/dxl/control_table_protocolversion.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="homing-offset"></a>**[Homing Offset(20)](#homing-offset20)**
{% include en/dxl/control_table_homingoffset.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="moving-threshold"></a>**[Moving Threshold(24)](#moving-threshold24)**
{% include en/dxl/control_table_movingthreshold.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="temperature-limit"></a>**[Temperature Limit(31)](#temperature-limit31)**
{% include en/dxl/control_table_temp_limit_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="max-voltage-limit"></a><a name="min-voltage-limit"></a>**[Min/Max Voltage Limit(32, 34)](#minmax-voltage-limit32-34)**
{% include en/dxl/control_table_volt_limit_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="pwm-limit"></a>**[PWM Limit(36)](#pwm-limit36)**
{% include en/dxl/control_table_pwm_limit.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="current-limit"></a>**[Current Limit(38)](#current-limit38)**
{% include en/dxl/control_table_current_limit.md passing_model = page.ref passed_ref = page.product_group %}
...
{% include en/dxl/control_table_vellimit.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="max-position-limit"></a><a name="min-position-limit"></a>**[Min/Max Position Limit(48, 52)](#minmax-position-limit48-52)**
{% include en/dxl/control_table_positionlimit.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="shutdown"></a>**[Shutdown(63)](#shutdown63)**
{% include en/dxl/control_table_shutdown.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="torque-enable"></a>**[Torque Enable(64)](#torque-enable64)**
{% include en/dxl/control_table_torque_enable.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="led"></a>**[LED(65)](#led65)**
{% include en/dxl/control_table_led.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="status-return-level"></a>**[Status Return Level(68)](#status-return-level68)**
{% include en/dxl/control_table_status_return_lv.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="registered-instruction"></a>**[Registered Instruction(69)](#registered-instruction69)**
{% include en/dxl/control_table_reg_instruction.md passing_model = page.ref passed_ref = page.product_group %}
...
{% include en/dxl/control_table_velocity_pi_gain.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="position-d-gain"></a><a name="position-i-gain"></a><a name="position-p-gain"></a><a name="feedforward-1st-gain"></a><a name="feedforward-2nd-gain"></a><a name="position-pid-gain80-82-84"></a><a name="feedforward-1st2nd-gains88-90"></a>**Position PID Gain(80, 82, 84), Feedforward 1st/2nd Gains(88, 90)**
{% include en/dxl/control_table_position_pid_gain.md passing_model = page.ref passed_ref = page.product_group %}
{% include en/dxl/control_table_current_position_pid_gain.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="bus-watchdog"></a>**[Bus Watchdog(98)](#bus-watchdog98)**
{% include en/dxl/control_table_buswatchdog.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="goal-pwm"></a>**[Goal PWM(100)](#goal-pwm100)**
{% include en/dxl/control_table_goal_pwm.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="goal-current"></a>**[Goal Current(102)](#goal-current102)**
{% include en/dxl/control_table_goal_current.md passing_model = page.ref passed_ref = page.product_group %}
...
{% include en/dxl/control_table_goal_velocity.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="profile-acceleration"></a>**[Profile Acceleration(108)](#profile-acceleration108)**
{% include en/dxl/control_table_profile_acceleration.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="profile-velocity"></a>**[Profile Velocity(112)](#profile-velocity112)**
{% include en/dxl/control_table_profile_velocity.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="goal-position"></a>**[Goal Position(116)](#goal-position116)**
{% include en/dxl/control_table_goal_position_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="realtime-tick"></a>**[Realtime Tick(120)](#realtime-tick120)**
{% include en/dxl/control_table_realtime_tick.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="moving"></a>**[Moving(122)](#moving122)**
{% include en/dxl/control_table_moving_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="moving-status"></a>**[Moving Status(123)](#moving-status123)**
{% include en/dxl/control_table_moving_status.md passing_model = page.ref passed_ref = page.product_group %}
...
{% include en/dxl/control_table_present_position.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="velocity-trajectory"></a>**[Velocity Trajectory(136)](#velocity-trajectory136)**
{% include en/dxl/control_table_velocity_trajectory.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="position-trajectory"></a>**[Position Trajectory(140)](#position-trajectory140)**
{% include en/dxl/control_table_position_trajectory.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="present-input-voltage"></a>**[Present Input Voltage(144)](#present-input-voltage144)**
{% include en/dxl/control_table_present_volt_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="present-temperature"></a>**[Present Temperature(146)](#present-temperature146)**
{% include en/dxl/control_table_present_temp_2.md passing_model = page.ref passed_ref = page.product_group %}

### <a name="indirect-address"></a><a name="indirect-data"></a>**[Indirect Address](#indirect-address)**, **[Indirect Data](#indirect-data)**
{% include en/dxl/control_table_indirect_data.md passing_model = page.ref passed_ref = page.product_group %}
