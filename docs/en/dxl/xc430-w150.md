...
{% assign passed_product_group = page.product_group %}

{% assign passed_model = page.ref %}
...
{% include en/dxl/control_table_mx_opmode_2.md passing_model = page.ref passed_ref = page.product_group %}
...
{% include en/dxl/control_table_present_load_2.md passing_model = page.ref passed_ref = page.product_group %}
