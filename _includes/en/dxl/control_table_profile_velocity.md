When the [Drive Mode(10)](/docs/en/popup/x/control_table_drivemode){: .popup} is **Velocity-based Profile**, Profile Velocity(112) sets the maximum velocity of the Profile.  
