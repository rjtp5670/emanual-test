...
- For instance, allocating 65 (Address of LED) to Indirect Address 1(168), Indirect Data 1(208) can perform exactly same as [LED(65)](#led-{{ passed_model }}){: .popup2}.
...
`Example 1` Allocating Size 1 byte [LED(65)](#led-{{ passed_model }}){: .popup2} to Indirect Data 1(208).
...
`Example 2` Allocating Size 4 byte [Goal Position(116)](#goal-position-{{ passed_model }}){: .popup2} to Indirect Data 2(225), 4 sequential bytes have to be allocated.
...
- For instance, allocating 65(Address of LED) to Indirect Address 1(168), Indirect Data 1(224) can perform exactly same as [LED(65)](#led-{{ passed_model }}){: .popup2}.
...
`Example 1` Allocating Size 1 byte [LED(65)](#led-{{ passed_model }}){: .popup2} to Indirect Data 1(224).
1. Indirect Address 1(168) : change the value to '65' which is the address of LED.
